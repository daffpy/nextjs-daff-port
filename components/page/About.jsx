        ...
        <div className="max-w-[550px] mx-auto mt-[160px]">
            <div className="mx-6">
                <div className="mt-[110px] text-[44px] font-htiny text-left">
                    <Image src={profilePic} style={{'borderRadius':'50%'}} width={130} height={130} alt="pp" placeholder="blur" />
                    ...
                    <div >
                        <div className="font-outfit font-light tracking-wide leading-relaxed text-[14px] md:text-[15px] mt-2">
                            ...
                            <p className="italic text-slate-600/70 dark:text-slate-400">
                    ...
                    <div>
                        <div className="font-outfit font-light tracking-wide text-[14px] md:text-[15px] mt-2 text-slate-600 dark:text-slate-300 leading-relaxed">
                            <p>
